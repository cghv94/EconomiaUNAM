...
learnr::question("¿Con qué función puedes graficar?", answer("var"), answer("median"), answer("plot", correct = TRUE), answer("summary"))
```

```{r pregunta2, echo=FALSE}
learnr::question("¿Con qué función puedes obtener el resumen estadístico de una serie de variables?", answer("summary", correct = TRUE), answer("cor"), answer("anova"), answer("head"))
```

```{r pregunta3, echo=FALSE}
learnr::question("¿Cuál el es código correcto para obtener un resumen estadístico del modelo 4?", answer("modelo4 <- lm(mpg ~ wt, mtcars)\n\nsummary(modelo4)", correct = TRUE), answer("modelo4 <- lm(mpg ~ wt, mtcars)\n\nplot(modelo4)"), answer("modelo4 <- lm(mpg ~ wt, mtcars)\n\ndata.frame(modelo4)"), answer("modelo4 <- lm(mpg ~ wt, mtcars)\n\ntable(modelo4)"))
```
