...
**Introducción**
 ...
 <img src="https://aga.frba.utn.edu.ar/wp-content/uploads/2016/08/081316_0002_PruebaMathT6.png">
  ...
  <p style="text-align: justify">Existen diversas clases de vectores, se clasifican de acuerdo a los elementos que contiene, los vectores con números reales se llaman Numeric, los vectores con caracteres lógicos se llaman Logic, los vectores con texto reciben el nombre de Character, entre otros, cada uno con características particulares que los vuelve una herramienta fundamental en el manejo del software R. [Ver más...](https://bookdown.org/jboscomendoza/r-principiantes4/vectores.html)</p>
