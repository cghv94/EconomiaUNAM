...
**Introducción**
 ...
 <img src="https://aga.frba.utn.edu.ar/wp-content/uploads/2016/08/081316_0002_PruebaMathT6.png">
  ...
  <p>
  <p style="text-align: justify">Un [vector](https://bookdown.org/jboscomendoza/r-principiantes4/vectores.html) en R es la manera más sencilla de establecer. Es una colección de uno o más datos del mismo tipo y nos sirven para construir matrices, listas, data frame, etc. Lo que posibilita que se pueda hacer análisis de datos al más alto nivel.
  ...
  <p style="text-align: justify">Con los vectores podemos realizar operaciones aritméticas que se aplican a cada uno de sus elementos. A este proceso le llamamos vectorización.[Ver más...](https://bookdown.org/jboscomendoza/r-principiantes4/vectores.html)</p>
...
**Ejercicio 2**
  ...
  <p style="text-align: justify">Crea dos vectores numéricos, primero con los números impares del 1 al 10 y el segundo los pares del 1 al 10, sumalos y al resultado réstale 2. </p>
...
**Ejercicio 3**
  ...
  <p style="text-align: justify">Multiplicar dos vectores secuencia el primero del 10 al 20 y el segundo del 1 al 10 y dividelo entre el siguiente vector 11,24,39,56,75,96,119,144,171,200.</p>
