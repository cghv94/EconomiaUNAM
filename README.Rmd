...
### Tutoriales y código útil
 ...
 + [R for Data Science en Español](https://es.r4ds.hadley.nz/): el famoso libro de Wickham y Grolemund, pero traducido al español.
 
 + [Introducción R, manipulación y visualización en R](http://www.castrolab.org/isme/introR/introR.html): es un libro electrónico con enfoque a manipulación y gráficación con `dplyr` y `ggplot2`
